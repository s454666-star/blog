...
$unsignedApk = Join-Path $buildDir 'folder-photo-tv-unsigned.apk'
$dexApk = Join-Path $buildDir 'folder-photo-tv-with-dex.apk'
$alignedApk = Join-Path $buildDir 'folder-photo-tv-aligned.apk'
$keystore = Join-Path $repoRoot 'storage\app\folder-photo-tv.keystore'
$legacyBuildKeystore = Join-Path $buildDir 'debug.keystore'
$outputApk = Join-Path $repoRoot 'storage\app\folder-photo-tv.apk'
