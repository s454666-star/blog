...
$unsignedApk = Join-Path $buildDir 'nas-viewer-unsigned.apk'
$dexApk = Join-Path $buildDir 'nas-viewer-with-dex.apk'
$alignedApk = Join-Path $buildDir 'nas-viewer-aligned.apk'
$keystore = Join-Path $repoRoot 'storage\app\nas-viewer-app.keystore'
