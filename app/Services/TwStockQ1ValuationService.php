...
class TwStockQ1ValuationService
{
    ...
    private const STOCK_GROUPS = [
        'IC設計' => [
            '2363', '2379', '2388', '2436', '2454', '2458', '3014', '3034', '3035', '3094',
            '3122', '3135', '3141', '3169', '3227', '3228', '3317', '3438', '3443', '3529',
            '3545', '3592', '3661', '3675', '4919', '4952', '4961', '4966', '4968', '5222',
            '5236', '5274', '5471', '6104', '6129', '6138', '6202', '6233', '6237', '6291',
            '6415', '6462', '6494', '6526', '6531', '6533', '6643', '6679', '6693', '6695',
            '6716', '6719', '6756', '6962', '7712', '8016', '8040', '8054', '8261',
        ],
        '記憶體/儲存' => [
        ...
        '半導體製造/設備/材料' => [
            ...
            '8028', '8086', '4749', '6788', '6532', '3583', '6829', '6830', '5443', '6139',
            '3402', '3467', '3707', '6823', '2340', '2467',
        ],
        'AI伺服器/電腦週邊' => [
            '2301', '2324', '2356', '2357', '2376', '2377', '2382', '2395', '2404', '2421',
            '3013', '3017', '3060', '3231', '3324', '3515', '3706', '4938', '6669', '8210',
            '8996', '2059',
        ],
        '電子設備/檢測' => [
        ...
        '高速傳輸/連接器' => [
            '2455', '3081', '3163', '3234', '3450', '6197', '6426', '6442',
        ],
        '光學/鏡頭' => [
            '2374', '3008', '3019',
        ],
        '電子零組件/PCB' => [
            '1471', '1504', '1582', '2313', '2368', '2383', '2392', '2428',
            '2474', '2492', '3037', '3044', '3189', '3321', '3338',
            '3376', '3533', '3653', '3715', '4958', '5469', '6269', '6274', '6278',
            '6290', '8046', '8105',
        ],
        '電子通路' => [
            '2347', '2736', '3033', '3036', '3055', '3528', '5434', '6265', '8070',
        ],
        '通信網路' => [
            '2412', '2439', '2485', '3138', '3221', '3379', '3380', '3704',
            '4904', '4906', '4909', '6245', '6285', '6546',
        ],
        '遊戲/數位內容' => [
            '3293',
        ],
        ...
        '汽車/電動車' => [
            ...
            '2231', '2233', '2236', '2239', '2241', '2247', '2250', '2497', '3665',
            '4763', '6288', '9951',
        ],
        '航太/國防' => [
            '2630', '2634', '4541', '5284', '8033',
        ],
        '精密機械/自動化' => [
            '1597', '2049', '4510', '4540', '4576', '6603', '7709', '8027', '8374',
        ],
        '電線電纜/重電' => [
            '1503', '1605', '1608', '1609', '1612',
        ],
        '運動休閒/品牌消費' => [
            '9921',
        ],
