    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', env('STAR_DB_HOST', '127.0.0.1')),
            'port' => env('DB_PORT', env('STAR_DB_PORT', '3306')),
            'database' => env('DB_DATABASE', env('STAR_DB_NAME', 'forge')),
            'username' => env('DB_USERNAME', env('STAR_DB_USER', 'forge')),
            'password' => env('DB_PASSWORD', env('STAR_DB_PASSWORD', '')),
