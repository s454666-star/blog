...
return [
    ...
    'display_min_seconds' => (int) env('FOLDER_PHOTO_DISPLAY_MIN_SECONDS', 3),
    'display_max_seconds' => (int) env('FOLDER_PHOTO_DISPLAY_MAX_SECONDS', 5),
    'app_version' => env('FOLDER_PHOTO_APP_VERSION', '2026.07.10.1'),
