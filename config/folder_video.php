...
return [
    ...
    'tv_preview_cache_path' => env('FOLDER_VIDEO_TV_PREVIEW_CACHE_PATH', storage_path('app/folder-video-previews/tv-sprites')),
    ...
    'app_version' => env('FOLDER_VIDEO_APP_VERSION', '2026.07.11.18'),
    ...
    'tv_android_apk_version_code' => (int) env('FOLDER_VIDEO_TV_ANDROID_APK_VERSION_CODE', 5),
    'tv_android_apk_version_name' => env('FOLDER_VIDEO_TV_ANDROID_APK_VERSION_NAME', '2026.07.11.5-tv'),
