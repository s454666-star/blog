...
return [
    ...
    'app_version' => env('FOLDER_VIDEO_APP_VERSION', '2026.07.11.22'),
    ...
    'android_apk_version_code' => (int) env('FOLDER_VIDEO_ANDROID_APK_VERSION_CODE', 13),
    'android_apk_version_name' => env('FOLDER_VIDEO_ANDROID_APK_VERSION_NAME', '2026.07.11.13'),
    'android_apk_path' => env('FOLDER_VIDEO_ANDROID_APK_PATH', storage_path('app/folder-video-app.apk')),
    'tv_android_apk_version_code' => (int) env('FOLDER_VIDEO_TV_ANDROID_APK_VERSION_CODE', 10),
    'tv_android_apk_version_name' => env('FOLDER_VIDEO_TV_ANDROID_APK_VERSION_NAME', '2026.07.11.10-tv'),
