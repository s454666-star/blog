...
return [
    ...
    'app_version' => env('FOLDER_VIDEO_APP_VERSION', '2026.07.11.21'),
    ...
    'tv_android_apk_version_code' => (int) env('FOLDER_VIDEO_TV_ANDROID_APK_VERSION_CODE', 8),
    'tv_android_apk_version_name' => env('FOLDER_VIDEO_TV_ANDROID_APK_VERSION_NAME', '2026.07.11.8-tv'),
