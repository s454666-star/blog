...
return [
    ...
    'app_version' => env('NAS_VIEWER_APP_VERSION', '2026.07.11.3'),
    ...
    'tv_android_apk_version_code' => (int) env('NAS_VIEWER_TV_ANDROID_APK_VERSION_CODE', 4),
    'tv_android_apk_version_name' => env('NAS_VIEWER_TV_ANDROID_APK_VERSION_NAME', '2026.07.11.4-tv'),
