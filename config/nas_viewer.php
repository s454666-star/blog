...
return [
    ...
    'app_version' => env('NAS_VIEWER_APP_VERSION', '2026.07.10.3'),
    'android_apk_version_code' => (int) env('NAS_VIEWER_ANDROID_APK_VERSION_CODE', 3),
    'android_apk_version_name' => env('NAS_VIEWER_ANDROID_APK_VERSION_NAME', '2026.07.10.3'),
