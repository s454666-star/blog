...
return [
    ...
    'page_limit' => (int) env('NAS_VIEWER_PAGE_LIMIT', 80),
    'max_page_limit' => (int) env('NAS_VIEWER_MAX_PAGE_LIMIT', 1000),
    'text_max_bytes' => (int) env('NAS_VIEWER_TEXT_MAX_BYTES', 5 * 1024 * 1024),
    'app_version' => env('NAS_VIEWER_APP_VERSION', '2026.07.11.10'),
    'android_apk_version_code' => (int) env('NAS_VIEWER_ANDROID_APK_VERSION_CODE', 11),
    'android_apk_version_name' => env('NAS_VIEWER_ANDROID_APK_VERSION_NAME', '2026.07.11.11'),
    'android_apk_path' => env('NAS_VIEWER_ANDROID_APK_PATH', storage_path('app/nas-viewer-app.apk')),
    'tv_android_apk_version_code' => (int) env('NAS_VIEWER_TV_ANDROID_APK_VERSION_CODE', 12),
    'tv_android_apk_version_name' => env('NAS_VIEWER_TV_ANDROID_APK_VERSION_NAME', '2026.07.11.12-tv'),
