...
return [
    ...
    'android_apk_version_code' => (int) env('NAS_VIEWER_ANDROID_APK_VERSION_CODE', 7),
    'android_apk_version_name' => env('NAS_VIEWER_ANDROID_APK_VERSION_NAME', '2026.07.11.7'),
    'android_apk_path' => env('NAS_VIEWER_ANDROID_APK_PATH', storage_path('app/nas-viewer-app.apk')),
    'tv_android_apk_version_code' => (int) env('NAS_VIEWER_TV_ANDROID_APK_VERSION_CODE', 8),
    'tv_android_apk_version_name' => env('NAS_VIEWER_TV_ANDROID_APK_VERSION_NAME', '2026.07.11.8-tv'),
