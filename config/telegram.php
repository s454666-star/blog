<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '3:JScodefilebot,7:JScodefilebot,8:zyxfiles1_bot'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES', '3,7,8'),
