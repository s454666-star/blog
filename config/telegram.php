<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '9:XDJMQBot,10:XllchaJSbot,11:PxxqzjzJSbot,12:NWdrivesbot'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES', '9,10,11,12'),
