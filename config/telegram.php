<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'source_peer_ids' => env('TELEGRAM_RESOURCE_CODE_SOURCE_PEER_IDS', '3779285711,2352070665,2668374810,3786977217,2895647646,2589355088,1886271900,2574836051,4385843192,4426897412,4495851100,3987680659,3797277766,2370972956,3742430847,4338853307,2627988497,4387333850,3978213171'),
            ...
            'bot_username' => env('TELEGRAM_RESOURCE_CODE_BOT_USERNAME', 'zyxfiles2_bot'),
            'code_type' => (int) env('TELEGRAM_RESOURCE_CODE_TYPE', 1),
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '1:zyxfiles2_bot,3:JScodefilebot,5:yyjmqg_bot,7:JScodefilebot'),
