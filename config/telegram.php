<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'source_peer_ids' => env('TELEGRAM_RESOURCE_CODE_SOURCE_PEER_IDS', '3779285711,2589355088,1886271900,2574836051,4426897412,3742430847,4338853307,2627988497,4387333850,3905588688,2374980053,3915216305'),
            ...
            'code_type' => (int) env('TELEGRAM_RESOURCE_CODE_TYPE', 15),
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '13:QzccuJSbot,15:shuttle67bot'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES', '13,15'),
