<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'source_peer_ids' => env('TELEGRAM_RESOURCE_CODE_SOURCE_PEER_IDS', '3779285711,2352070665,2668374810,3786977217,2895647646,2589355088,1886271900,2574836051,4385843192,4426897412,4495851100,3987680659,3797277766'),
            ...
            'bot_username' => env('TELEGRAM_RESOURCE_CODE_BOT_USERNAME', 'JSfilesbot'),
            'code_type' => (int) env('TELEGRAM_RESOURCE_CODE_TYPE', 4),
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '3:JSfileeesbot,5:yyjmq_bot'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES', '3,5'),
