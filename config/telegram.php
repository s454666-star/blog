<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'source_peer_ids' => env('TELEGRAM_RESOURCE_CODE_SOURCE_PEER_IDS', '3779285711,2352070665,2668374810,4451551324,3786977217,3948153894'),
            ...
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES'),
