<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '3:JSfileeesbot,5:yyjmq_bot,6:bffilesbot'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES', '1,3,5,6'),
