<?php
    ...
    return [
        ...
        'resource_codes' => [
            ...
            'processing_profiles' => env('TELEGRAM_RESOURCE_CODE_PROCESSING_PROFILES', '3:JSfilesebot,4:JSfilesbot,5:yyjmq_bot'),
            'scan_code_types' => env('TELEGRAM_RESOURCE_CODE_SCAN_TYPES', '3,4,5'),
