...
class ResourceCodeDormantTextTest(unittest.TestCase):
    ...
    def test_jsfileeesbot_codes_are_accepted_and_prefix_is_normalized(self) -> None:
        self.assertEqual(
            "JSfileeesbot_87V0P0D_2TZN-NN8C",
            service._normalize_resource_code("jsfileeesbot_87V0P0D_2TZN-NN8C"),
        )
    ...
    def test_yyjmqg_codes_are_accepted_and_prefix_is_normalized(self) -> None:
        self.assertEqual(
            ...
            service._normalize_resource_code("YYJMQG_BOT_87V0P0D_2TZN-NN8C"),
        )
        self.assertIsNone(service._normalize_resource_code("yyjmq_bot_87V0P0D_2TZN-NN8C"))
        self.assertIsNone(service._normalize_resource_code("yyjmqh_bot_87V0P0D_2TZN-NN8C"))
        self.assertIsNone(service._normalize_resource_code("notyyjmqg_bot_87V0P0D_2TZN-NN8C"))
    ...
    def test_jscodefilebot_codes_are_accepted_and_prefix_is_normalized(self) -> None:
        self.assertEqual(
            "JScodefilebot_87V0P0D_2TZN-NN8C",
            service._normalize_resource_code("jscodefilebot_87V0P0D_2TZN-NN8C"),
        )
        self.assertIsNone(service._normalize_resource_code("notJScodefilebot_87V0P0D_2TZN-NN8C"))

    def test_zyxfiles_codes_are_accepted_and_prefix_is_normalized(self) -> None:
        self.assertEqual(
            "zyxfiles_87V0P0D_2TZN-NN8C",
            service._normalize_resource_code("ZYXFILES_87V0P0D_2TZN-NN8C"),
        )
        self.assertIsNone(service._normalize_resource_code("notzyxfiles_87V0P0D_2TZN-NN8C"))
...
class TdlProtectedCopySafetyTest(unittest.IsolatedAsyncioTestCase):
    def test_copy_download_timeouts_bound_stalled_fallbacks(self) -> None:
        ...
        self.assertEqual(900, service.TDL_COPY_DOWNLOAD_TIMEOUT_SECONDS)
        self.assertEqual(3600, service.TELETHON_COPY_DOWNLOAD_TIMEOUT_SECONDS)
