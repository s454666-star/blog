...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box } html { min-height:100%; background:var(--bg) } body { margin:0; min-height:100vh; color:var(--text); font-family:Inter,"Noto Sans TC","Microsoft JhengHei",sans-serif; background:radial-gradient(circle at 15% 10%,rgba(124,92,255,.2),transparent 28%),radial-gradient(circle at 88% 20%,rgba(54,217,239,.15),transparent 25%),linear-gradient(145deg,#060713,#0b1025 55%,#090919); overflow-x:hidden }
        ...
        table { width:100%;border-collapse:collapse } th { padding:13px 16px;text-align:left;color:#7783a5;font-size:12px;letter-spacing:.5px;border-bottom:1px solid var(--line) } td { padding:15px 16px;border-bottom:1px solid rgba(255,255,255,.075);color:#e2e6f5;vertical-align:middle } tbody tr { transition:.18s } tbody tr:nth-child(odd) { background:var(--row-odd) } tbody tr:nth-child(even) { background:var(--row-even) } tbody tr:hover { background:var(--row-hover) }.table-wrap{overflow-x:auto}.empty{text-align:center;padding:70px 20px;color:var(--muted)}
