...
<article class="match-card" @if($showCheckbox) data-match-id="{{ $entry['id'] }}" data-collapsible-card @endif>
    <div class="match-head">
        ...
        <div class="match-head-right">
            @if ($showCheckbox)
                <button class="btn btn-soft card-toggle-btn" data-card-toggle type="button" aria-expanded="true">收起卡片</button>
            @endif
    ...
    <div class="match-body" @if($showCheckbox) data-card-body @endif>
