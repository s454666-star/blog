...
use App\Http\Controllers\VideoRerunSyncController;
...
Route::prefix('admin')->name('customer-admin.')->group(function () {
    ...
    Route::middleware('customer.admin')->group(function () {
        ...
        Route::post('/orders/activity-log', [CustomerAdminController::class, 'logOrderActivity'])->name('orders.activity-log');
        ...
        Route::post('/{module}', [CustomerAdminController::class, 'store'])->whereIn('module', ['contacts', 'products', 'orders'])->name('module.store');
        Route::get('/{module}/{id}/edit', [CustomerAdminController::class, 'edit'])->whereIn('module', ['contacts', 'products', 'orders'])->whereNumber('id')->name('module.edit');
        Route::put('/{module}/{id}', [CustomerAdminController::class, 'update'])->whereIn('module', ['contacts', 'products', 'orders'])->whereNumber('id')->name('module.update');
        Route::delete('/{module}/{id}', [CustomerAdminController::class, 'destroy'])->whereIn('module', ['contacts', 'products', 'orders'])->whereNumber('id')->name('module.destroy');
    });
});
...
Route::get('/tw-stock/esun-portfolio/intraday', [EsunPortfolioController::class, 'intraday'])->name('tw-stock.esun-portfolio.intraday');
...
Route::get('/tw-stock/yuanta-portfolio/intraday', [YuantaPortfolioController::class, 'intraday'])->name('tw-stock.yuanta-portfolio.intraday');
...
Route::get('/videos/rerun-sync', [VideoRerunSyncController::class, 'index'])->name('videos.rerun-sync.index');
Route::post('/videos/rerun-sync/apply', [VideoRerunSyncController::class, 'apply'])->name('videos.rerun-sync.apply');
