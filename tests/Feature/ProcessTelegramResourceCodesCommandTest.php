...
class ProcessTelegramResourceCodesCommandTest extends TestCase
{
    ...
    public function test_scan_stores_only_unique_zyxfiles_codes_with_type_one_and_no_message_text(): void
    {
    ...
    public function test_production_profiles_process_type_one_zyxfiles_but_ignore_legacy_hex_and_disabled_prefixes(): void
    {
        config()->set('telegram.resource_codes.processing_profiles', '1:zyxfiles2_bot,3:JScodefilebot,5:yyjmqg_bot,7:JScodefilebot');
        config()->set('telegram.resource_codes.scan_code_types', '1,3,5,7');
            ...
            if ($request->method() === 'GET') {
                return Http::response([
                    ...
                    'items' => [[
                        'id' => 104801,
                        'text' => implode(' ', [
                            'ZYXFILES_active_A1-b2',
                            '4DC6EB55EE68F197A332CA4802AAF14420F76D74',
                            'yyjmq_bot_disabled_A1-b2',
                            'bffilesbot_disabled_A1-b2',
                        ]),
                    ]],
                ]);
            }

            $this->assertSame('zyxfiles_active_A1-b2', $request['code']);
            $this->assertSame('zyxfiles2_bot', $request['bot_username']);
    ...
    public function test_scan_limits_a_forum_source_to_its_configured_topic(): void
    {
        ...
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'zyxfiles_topic_A1-b2',
            'source_peer_id' => 2589355088,
            'source_message_id' => 321,
        ]);
    }

    public function test_scan_tries_other_accounts_when_a_source_is_missing_from_earlier_accounts(): void
    {
        config()->set('telegram.resource_codes.base_uris', 'http://127.0.0.1:8002,http://127.0.0.1:8003,http://127.0.0.1:8004');
        config()->set('telegram.resource_codes.source_peer_ids', '4387333850');

        $requestedPorts = [];
        Http::fake(function ($request) use (&$requestedPorts) {
            $port = (int) parse_url($request->url(), PHP_URL_PORT);
            $requestedPorts[] = $port;
            ...
            return Http::response([
                ...
                'items' => [[
                    'id' => 654321,
                    'text' => 'ZYXFILES_account_fallback_A1-b2',
                ]],
            ]);
        });
        ...
        $this->assertSame([8002, 8003, 8004], $requestedPorts);
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'zyxfiles_account_fallback_A1-b2',
            'code_type' => 1,
            'source_peer_id' => 4387333850,
            'source_message_id' => 654321,
        ]);
    }
    ...
    public function test_type_three_scan_stores_only_jsfileeesbot_codes_and_preserves_suffix_case(): void
    {
        Http::fake(Http::response([
            ...
            'items' => [[
                'id' => 119900,
                'text' => implode("\n", [
                    'JSfileeesbot_87V0P0D_2TZN-NN8C',
                    'jsfileeesbot_a1B2_c3-D4',
                    'JSfilesbot_87V0P0D_2TZN-NN8C',
                    'notJSfileeesbot_87V0P0D_2TZN-NN8C',
                ]),
            ]],
        ]));
    ...
    public function test_type_three_duplicate_across_sources_is_stored_and_forwarded_only_once(): void
    {
        $forwardCount = 0;
        ...
        Http::fake(function ($request) use (&$forwardCount) {
            if ($request->method() === 'GET') {
                return Http::response([
                    ...
                    'items' => [[
                        'id' => 119904,
                        'text' => 'JSfileeesbot_duplicate_A1-b2',
                    ]],
                ]);
            }

            $forwardCount++;
            $this->assertSame('JSfileeesbot_duplicate_A1-b2', $request['code']);
            $this->assertSame('JScodefilebot', $request['bot_username']);
        ...
        $this->assertDatabaseCount('telegram_resource_codes', 1);
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'JSfileeesbot_duplicate_A1-b2',
            'code_type' => 3,
            'status' => TelegramResourceCode::STATUS_COMPLETED,
            'attempts' => 1,
    ...
    public function test_type_five_scan_stores_only_yyjmqg_codes_and_preserves_suffix_case(): void
    {
        Http::fake(Http::response([
            'status' => 'ok',
            'items' => [[
                ...
                'text' => implode("\n", [
                    ...
                    'notyyjmqg_bot_87V0P0D_2TZN-NN8C',
                ]),
            ]],
        ]));
    ...
    public function test_type_five_duplicate_across_sources_is_sent_to_yyjmqg_and_forwarded_only_once(): void
    {
        $forwardCount = 0;
        ...
        Http::fake(function ($request) use (&$forwardCount) {
            ...
            return Http::response([
                'status' => 'ok',
                'forwarded_count' => 12,
                'expected_media_count' => 12,
                'declared_file_count' => 12,
                'cleanup_complete' => true,
            ]);
        });
        ...
        $this->assertDatabaseHas('telegram_resource_codes', [
            ...
            'status' => TelegramResourceCode::STATUS_COMPLETED,
            'attempts' => 1,
            'forwarded_message_count' => 12,
            'decoder_sent_count' => 12,
            'decoder_total_count' => 12,
        ]);
    }

    public function test_type_six_scan_stores_only_bffilesbot_codes_and_preserves_suffix_case(): void
    {
        Http::fake(Http::response([
            'status' => 'ok',
            'items' => [[
                ...
                'text' => implode("\n", [
                    ...
                    'BFFILESBOT_a1B2_c3-D4',
                    'bffilebot_87V0P0D_2TZN-NN8C',
                    'notbffilesbot_87V0P0D_2TZN-NN8C',
                ]),
            ]],
        ]));
    ...
    public function test_type_six_duplicate_across_sources_is_stored_and_forwarded_only_once(): void
    {
        $forwardCount = 0;
        ...
        Http::fake(function ($request) use (&$forwardCount) {
            if ($request->method() === 'GET') {
                return Http::response([
                    ...
                    'items' => [[
                        'id' => 119906,
                        'text' => 'bffilesbot_duplicate_A1-b2',
                    ]],
                ]);
            }

            $forwardCount++;
            $this->assertSame('bffilesbot_duplicate_A1-b2', $request['code']);
            $this->assertSame('bffilesbot', $request['bot_username']);
        ...
        $this->assertDatabaseCount('telegram_resource_codes', 1);
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'bffilesbot_duplicate_A1-b2',
            'code_type' => 6,
            'status' => TelegramResourceCode::STATUS_COMPLETED,
            'attempts' => 1,
            'forwarded_message_count' => 1,
    ...
    public function test_type_seven_scans_jscodefilebot_and_routes_once_to_jscodefilebot(): void
    {
        $forwardCount = 0;
        ...
        Http::fake(function ($request) use (&$forwardCount) {
            if ($request->method() === 'GET') {
                return Http::response([
                    ...
                    'items' => [[
                        'id' => 119907,
                        'text' => implode("\n", [
                            'jscodefilebot_newroute_A1-b2',
                            'JScodefilebotx_newroute_A1-b2',
                            'notJScodefilebot_newroute_A1-b2',
                        ]),
                    ]],
                ]);
            }
            ...
            $forwardCount++;
            $this->assertSame('JScodefilebot_newroute_A1-b2', $request['code']);
            $this->assertSame('JScodefilebot', $request['bot_username']);
        ...
        $this->assertDatabaseCount('telegram_resource_codes', 1);
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'JScodefilebot_newroute_A1-b2',
            'code_type' => 7,
            'status' => TelegramResourceCode::STATUS_COMPLETED,
            'forwarded_message_count' => 12,
        ]);
    ...
    public function test_type_one_scans_zyxfiles_and_routes_once_to_zyxfiles2_bot(): void
    {
        $forwardCount = 0;
        ...
        Http::fake(function ($request) use (&$forwardCount) {
            if ($request->method() === 'GET') {
                return Http::response([
                    ...
                    'items' => [[
                        'id' => 119909,
                        'text' => implode("\n", [
                            'ZYXFILES_newroute_A1-b2',
                            'zyxfile_newroute_A1-b2',
                            'notzyxfiles_newroute_A1-b2',
                        ]),
                    ]],
                ]);
            }
            ...
            $forwardCount++;
            $this->assertSame('zyxfiles_newroute_A1-b2', $request['code']);
            $this->assertSame('zyxfiles2_bot', $request['bot_username']);

            return Http::response([
                'status' => 'ok',
                'forwarded_count' => 11,
                'expected_media_count' => 11,
                'declared_file_count' => 11,
                'cleanup_complete' => true,
            ]);
        });
        ...
        $this->artisan('telegram:process-resource-codes', [
            ...
            '--process-limit' => 2,
            '--code-type' => 1,
            '--bot-username' => 'zyxfiles2_bot',
        ])->assertExitCode(0);

        $this->assertSame(1, $forwardCount);
        $this->assertDatabaseCount('telegram_resource_codes', 1);
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'zyxfiles_newroute_A1-b2',
            'code_type' => 1,
            'status' => TelegramResourceCode::STATUS_COMPLETED,
            'forwarded_message_count' => 11,
        ]);
    }

    public function test_type_one_accepts_hyphen_delimiter_and_preserves_suffix_case(): void
    {
        $forwardCount = 0;
    ...
    public function test_worker_scans_type_two_and_three_but_only_claims_type_three(): void
    {
            ...
            if ($request->method() === 'GET' && str_starts_with($path, '/groups/')) {
                return Http::response([
                    ...
                    'items' => [[
                        ...
                        'text' => implode(' ', [
                            'WenJianJiJibot_1v_imWSCOeauMVsszgd',
                            'JSfileeesbot_qqcode10884fe700_9V',
                        ]),
                    ]],
                ]);
            }

            $this->assertSame('JSfileeesbot_qqcode10884fe700_9V', $request['code']);
            $this->assertSame('JScodefilebot', $request['bot_username']);
        ...
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code' => 'JSfileeesbot_qqcode10884fe700_9V',
            'code_type' => 3,
            'status' => TelegramResourceCode::STATUS_COMPLETED,
            'attempts' => 1,
    ...
    {
        config()->set('telegram.resource_codes.processing_profiles', '1:zyxfiles2_bot,2:WenJianJiJibot,3:JScodefilebot,4:JSfilesbot,5:yyjmqg_bot,6:bffilesbot,7:JScodefilebot,8:zyxfiles1_bot');
        config()->set('telegram.resource_codes.scan_code_types', '1,2,3,4,5,6,7,8');

        DB::table('telegram_resource_codes')->insert([
            [
                'code' => 'zyxfiles_type1_A1-b2',
                'code_type' => 1,
                'status' => TelegramResourceCode::STATUS_PENDING,
                'attempts' => 0,
                'forwarded_message_count' => 0,
            ...
            [
                'code' => 'yyjmqg_bot_87V0P0D_2TZN-NN8C',
                'code_type' => 5,
                'status' => TelegramResourceCode::STATUS_PENDING,
                'attempts' => 0,
                'forwarded_message_count' => 0,
            ...
            [
                'code' => 'bffilesbot_87V0P0D_2TZN-NN8C',
                'code_type' => 6,
                'status' => TelegramResourceCode::STATUS_PENDING,
                'attempts' => 0,
                'forwarded_message_count' => 0,
            ...
            [
                'code' => 'JScodefilebot_type7_A1-b2',
                'code_type' => 7,
                'status' => TelegramResourceCode::STATUS_PENDING,
                'attempts' => 0,
                'forwarded_message_count' => 0,
        ...
        $this->assertSame(['zyxfiles2_bot', 'WenJianJiJibot', 'JScodefilebot', 'JSfilesbot', 'yyjmqg_bot', 'bffilesbot', 'JScodefilebot', 'zyxfiles1_bot'], $sentBots);
        $this->assertDatabaseHas('telegram_resource_codes', [
            'code_type' => 1,
            'status' => TelegramResourceCode::STATUS_COMPLETED,
        ]);
    ...
    public function test_multiple_profiles_rotate_code_types_instead_of_draining_one_type_first(): void
    {
        ...
        foreach ([
            ['zyxfiles_type1_retry_A1-b2', 1],
            ['zyxfiles_type1_new_A1-b2', 1],
            ['WenJianJiJibot_1v_EY7hgrHmiujLKVaV', 2],
            ['JSfileeesbot_10506_69799_143-42', 3],
            ['JSfile_bot_87V0P0D_2TZN-NN8C', 4],
            ['yyjmqg_bot_87V0P0D_2TZN-NN8C', 5],
            ['bffilesbot_87V0P0D_2TZN-NN8C', 6],
            ['JScodefilebot_type7_A1-b2', 7],
            ['zyxfiles_type8_A1-b2', 8],
        ] as [$code, $codeType]) {
            DB::table('telegram_resource_codes')->insert([
                'code' => $code,
                'code_type' => $codeType,
    ...
    public function test_type_two_worker_does_not_claim_type_one_rows(): void
    {
        DB::table('telegram_resource_codes')->insert([
            [
                'code' => 'zyxfiles_type1_pending_A1-b2',
                'code_type' => 1,
                'status' => TelegramResourceCode::STATUS_PENDING,
                'attempts' => 0,
                'forwarded_message_count' => 0,
    ...
    {
        config()->set('telegram.resource_codes.processing_profiles', '1:zyxfiles2_bot,2:WenJianJiJibot');
        config()->set('telegram.resource_codes.scan_code_types', '1,2,3');

        DB::table('telegram_resource_codes')->insert([
            [
                'code' => 'zyxfiles_cooldown_A1-b2',
                'code_type' => 1,
                'status' => TelegramResourceCode::STATUS_PENDING,
                'attempts' => 0,
                'forwarded_message_count' => 0,
        ...
        foreach ([8001, 8002, 8003] as $port) {
            $baseUri = "http://127.0.0.1:{$port}";
            Cache::store('telegram_resource_codes')->put(
                'telegram_resource_codes:decoder_cooldown:' . sha1('zyxfiles2_bot|' . $baseUri),
                time() + 900,
                now()->addMinutes(16)
            );
        }
